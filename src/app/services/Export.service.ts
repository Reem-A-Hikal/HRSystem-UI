...
export class ExportService {
  exportToExcel(records: AttendanceRecord[], title?: string): void {
  ...
  exportToPDF(records: AttendanceRecord[], logoBase64?: string): void {
    const doc = new jsPDF({
    ...
    if (logoBase64) {
      doc.addImage(logoBase64, 'PNG', margin, 10, 60, 40);
    }
